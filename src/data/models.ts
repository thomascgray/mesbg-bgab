...
let _models: { [key: string]: Omit<iModel, "key"> } = {
  ...
  KhandishKing: {
    ...
    wargear: [options.HeavyArmour, options.HandAndAHalfAxe, options.Bow],
    wargearOptions: [
      { ...options.KhandishChariot, cost: 30 },
      { ...options.Horse, cost: 10 },
    ],
  },
  KhandishChieftan: {
    name: "KhandishChieftan",
    heroLevel: eHeroLevel.Valour,
    cost: 55,
    stats: {
      Mv: 6,
  ...
  KhandishWarrior: {
    ...
    wargear: [options.Armour, options.HandAndAHalfAxe, options.Dagger],
    wargearOptions: [{ ...optionSwaps.HandAndAHalfAxeForBow, cost: 0 }],
  },
  KhandishHorseman: {
    name: "KhandishHorseman",
    cost: 13,
    stats: {
      Mv: 6,
      F1: 4,
  ...
  KhandishCharioteer: {
    ...
    wargear: [
      ...
      options.HandAndAHalfAxe,
      options.Dagger,
      options.KhandishChariot,
    ],
    wargearOptions: [{ ...optionSwaps.HandAndAHalfAxeForBow, cost: 0 }],
  },

  SuladanTheSerpentLord: {
    name: "SuladanTheSerpentLord",
    heroLevel: eHeroLevel.Legend,
    cost: 100,
    stats: {
      Mv: 6,
    ...
    wargear: [options.Armour, options.Sword, options.TheSerpentBanner],
    wargearOptions: [
      { ...options.ArmouredHorse, cost: 15 },
      { ...options.BowWithPoisonedArrows, cost: 5 },
    ],
  },
  ...
  HaradrimKing: {
    ...
    wargearOptions: [
      { ...options.Horse, cost: 10 },
      { ...options.BowWithPoisonedArrows, cost: 5 },
      { ...options.WarSpear, cost: 5 },
    ],
  },

  TheGoldenKingOfAbrakhan: {
    name: "TheGoldenKingOfAbrakhan",
    heroLevel: eHeroLevel.Valour,
    cost: 130,
    stats: {
      Mv: 6,
    ...
    wargear: [options.TwoHandedWeapon, options.TheGoldenThrone],
    wargearOptions: [],
  },
  ...
  Hasharin: {
    ...
    wargear: [options.Daggers, options.ThrowingDaggers, options.Blowpipe],
    wargearOptions: [],
  },

  HaradrimChieftan: {
    name: "HaradrimChieftan",
    heroLevel: eHeroLevel.Fortitude,
    cost: 80,
    stats: {
      Mv: 6,
    ...
    wargear: [options.Armour, options.WarSpear, options.Sword],
    wargearOptions: [
      { ...options.Horse, cost: 10 },
      { ...options.BowWithPoisonedArrows, cost: 5 },
    ],
  ...
  WarMumakOfHarad: {
    name: "WarMumakOfHarad",
    heroLevel: eHeroLevel.Fortitude,
    cost: 275,
    profiles: [
      {
        key: "HaradrimCommander",
        name: "HaradrimCommander",
        stats: {
          Mv: 6,
          F1: 4,
          F2: 4,
        ...
        wargear: [options.Armour, options.WarSpear],
      },
      {
        key: "Mumak",
        name: "Mumak",
    ...
    wargearOptions: [
      { ...optionUpgrades.WarMumakOfHaradGnarledHide, cost: 30 },
      { ...optionUpgrades.WarMumakOfHaradMahudBeastmasterChieftan, cost: 25 },
      { ...optionUpgrades.WarMumakOfHaradRocks, cost: 20 },
      { ...optionUpgrades.WarMumakOfHaradSigilsOfDefiance, cost: 20 },
      { ...optionUpgrades.WarMumakOfHaradTuskWeapons, cost: 20 },
      { ...optionUpgrades.WarMumakOfHaradFoulTemperament, cost: 15 },
      { ...optionUpgrades.WarMumakOfHaradRapellingLines, cost: 10 },
    ],
  },

  HaradrimTaskmaster: {
    name: "HaradrimTaskmaster",
    heroLevel: eHeroLevel.Fortitude,
    cost: 50,
    stats: {
      Mv: 6,
    ...
    wargear: [options.Armour, options.Club, options.Whip],
    wargearOptions: [],
  },

  HaradrimWarrior: {
    name: "HaradrimWarrior",
    cost: 6,
    stats: {
      Mv: 6,
      F1: 3,
    ...
    wargearOptions: [
      { ...options.Warhorn, cost: 30 },
      { ...options.Banner, cost: 25 },
      { ...options.BowWithPoisonedArrows, cost: 1 },
      { ...options.Spear, cost: 1 },
    ],
  },
  ...
  HaradrimRaider: {
    ...
    wargear: [options.Armour, options.Dagger, options.Horse],
    wargearOptions: [
      { ...options.Banner, cost: 25 },
      { ...options.BowWithPoisonedArrows, cost: 1 },
      { ...options.WarSpear, cost: 1 },
    ],
  },
  ...
  SerpentRider: {
    ...
    wargear: [options.Armour, options.WarSpear, options.Horse],
    wargearOptions: [],
  },
  ...
  WatcherOfKarna: {
    ...
    wargear: [options.Sword, optionChoice.TwinBladesOrBowWithPoisonedArrows],
    wargearOptions: [],
  },

  AbrakhanMerchantGuard: {
    name: "AbrakhanMerchantGuard",
    cost: 9,
    stats: {
      Mv: 6,
      F1: 4,
    ...
    wargear: [options.TwoHandedSword],
    wargearOptions: [],
  },
  ...
  MahudKing: {
    ...
    wargear: [options.Armour, options.Club, options.Whip],
    wargearOptions: [
      { ...options.WarCamel, cost: 10 },
      { ...options.PoisonedBlowpipe, cost: 5 },
      { ...options.Shield, cost: 5 },
      { ...options.WarSpear, cost: 5 },
    ],
  },
  ...
  MahudWarrior: {
    ...
    wargear: [options.Armour, options.Club, options.Shield],
    wargearOptions: [
      { ...options.Banner, cost: 25 },
      { ...options.PoisonedBlowpipe, cost: 1 },
      { ...options.Spear, cost: 1 },
    ],
  },
  ...
  MahudRaider: {
    ...
    wargear: [options.Armour, options.Club, options.Shield, options.WarCamel],
    wargearOptions: [
      { ...options.Banner, cost: 25 },
      { ...options.PoisonedBlowpipe, cost: 1 },
      { ...options.WarSpear, cost: 1 },
  ...
  HalfTroll: {
    ...
    wargear: [options.Armour, options.Club],
    wargearOptions: [{ ...options.TwoHandedClub, cost: 1 }],
  },

  DalamyrFleetmasterOfUmbar: {
    name: "DalamyrFleetmasterOfUmbar",
    heroLevel: eHeroLevel.Legend,
    cost: 90,
    stats: {
      Mv: 6,
    ...
    wargear: [options.Sword, options.ThrowingDaggers, options.SmokeBombs],
    wargearOptions: [
      { ...options.WarCamel, cost: 10 },
      { ...options.PoisonedBlowpipe, cost: 5 },
      { ...options.Shield, cost: 5 },
  ...
  CorsairCaptain: {
    ...
    wargear: [options.Sword, options.ThrowingDaggers],
    wargearOptions: [
      { ...options.Bow, cost: 5 },
      { ...options.Crossbow, cost: 5 },
      { ...options.Shield, cost: 5 },
  ...
  CorsairArbalester: {
    ...
    wargear: [options.Crossbow, options.Dagger, options.Pavise],
    wargearOptions: [],
  },
    ...
    profiles: [
      {
        ...
        wargear: [options.TwoHandedStaff, options.Dagger],
      },
      {
        key: "SharkeyAndWormWorm",
        name: "Worm",
        stats: {
          Mv: 6,
          F1: 2,
  ...
  Ruffian: {
    ...
    wargear: [optionChoice.KnifeOrClub],
    wargearOptions: [
      { ...options.Bow, cost: 1 },
      { ...options.Whip, cost: 1 },
    ],
